      ...
      >
        ...
        >
          ...
          <p className="my-5">
            ...
            Laboriosam, fugit eum. Voluptates minus, cum impedit blanditiis amet
            inventore, exercitationem, rem quo animi numquam ullam veniam quia
            voluptas doloremque sapiente repellat!
          </p>
        </motion.div>
        {/* FORM AND IMAGE */}
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              target="_blank"
              onSubmit={onSubmit}
              action="https://formsubmit.co/akintobiafeez374@gmail.com"
              method="POST"
            >
              <input
